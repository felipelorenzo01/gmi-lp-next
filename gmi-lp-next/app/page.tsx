...
/* ── Botões ── */
function BtnRed({ children, href = "#contato", size = "md" }:
  { children: React.ReactNode; href?: string; size?: "sm" | "md" | "lg" }) {
  const sizes = {
    sm: "px-7 py-2.5 text-sm min-w-[170px]",
    md: "px-10 py-4 text-base min-w-[220px]",
    lg: "px-14 py-5 text-lg min-w-[300px]",
  };
  return (
    <a href={href} className={`inline-flex items-center justify-center rounded-full
      bg-gmi-red font-sans font-semibold text-white transition hover:bg-gmi-red-dark
      focus:outline-none focus:ring-4 focus:ring-gmi-red/30 ${sizes[size]}`}>
      {children}
    </a>
  );
}
  ...
  return (
    <main>
      ...
      */}
      ...
      {/* ── FITAS ADESIVAS ── */}
      <section className="overflow-hidden bg-[#e8e6e1] py-14">
        <div className="container-gmi grid items-center gap-8 md:grid-cols-[38%_62%]">
          ...
          {/* Imagem maior, ocupando mais a seção */}
          <div className="relative w-full" style={{ minHeight: "460px" }}>
            <Image src="/img/fitas-desktop.png" alt="Linha de fitas adesivas"
              fill sizes="(max-width:768px) 100vw, 62vw"
              className="object-contain object-right scale-[1.3] origin-bottom-right" />
          </div>
        </div>

        {/* CTA abaixo, alinhado com a coluna da imagem */}
        <div className="container-gmi mt-2 grid md:grid-cols-[38%_62%]">
          <div className="hidden md:block" />
          <div className="flex justify-center md:justify-start">
            <BtnRed size="lg">Solicitar orçamento</BtnRed>
          </div>
        </div>
      </section>
      ...
      {/*
        ...
        Produtos na metade esquerda; botão abaixo da imagem (como no PDF), menor.
      */}
      <section className="overflow-hidden py-14 text-white" style={{ backgroundColor: "#013DFF" }}>
        <div className="container-gmi grid items-center gap-8 md:grid-cols-[60%_40%]">

          {/* Imagem maior + botão abaixo dela */}
          <div className="order-2 flex flex-col items-center md:order-1 md:items-start">
            <div className="relative w-full" style={{ minHeight: "440px" }}>
              <Image src="/img/automotivo-desktop.png"
                ...
                className="object-contain object-left scale-[1.25] origin-bottom-left" />
            </div>
            <div className="mt-2"><BtnRed size="sm">Solicitar orçamento</BtnRed></div>
          </div>
      ...
      {/* ── MÁQUINAS ── */}
      <section className="overflow-hidden bg-[#f0efed] py-14">
        <div className="container-gmi grid items-center gap-8 md:grid-cols-[40%_60%]">
          ...
          {/* Máquina maior, ocupando mais a seção */}
      ...
      <footer className="bg-gmi-paper py-8">
        <div className="container-gmi flex flex-col items-center justify-between gap-6
          ...
          <div className="flex items-center gap-3">
            <a href="https://api.whatsapp.com/send?phone=553134900777"
            ...
            <a href="https://www.instagram.com/gmi_bh" target="_blank" rel="noopener" aria-label="Instagram"
              className="flex h-11 w-11 items-center justify-center rounded-full
                bg-gmi-navy text-white hover:bg-gmi-navy/80 transition">
              <svg viewBox="0 0 24 24" className="h-5 w-5" fill="currentColor">
