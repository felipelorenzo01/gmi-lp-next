  ...
  return (
    <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div className="sm:col-span-2 mt-2">
        <button type="submit" disabled={status === "sending"} className="inline-flex items-center justify-center rounded-full bg-gmi-navy px-10 py-3.5 font-sans text-base font-semibold text-white transition hover:bg-gmi-navy/80 disabled:opacity-60 w-full sm:w-auto">
