...
/**
 * Monta o corpo do "Importar contato" conforme doc SURI:
 * POST CHATBOT-URL/api/contacts
 *
 * Campos obrigatórios:
...
function buildImportContactBody(lead: NormalizedLead, q: Qualification) {
  return {
    name:        lead.nome,
    phone:       lead.whatsappE164,   // já no formato 55DDD9XXXXXXXX
    email:       lead.email,
    gender:      2,                    // indefinido
